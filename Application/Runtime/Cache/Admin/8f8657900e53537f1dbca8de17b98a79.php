...
<div class="page-container">
	...
	<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Orders Ongoing <small> orders ongoing listing</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo U('Order/orderlist_ongoing');;?>">Orders Ongoing</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-shopping-cart"></i>Ongoing Orders Listing
							</div>
							<div class="actions">
								<a href="<?php echo U('Order/orderaddpage?go=1');;?>" class="btn default yellow-stripe">
						...
						<div class="portlet-body">
							<div class="table-container">
								<div class="row">
									<form role="form" action="<?php echo U('Order/orderlist_ongoing?p=1');;?>" method="GET">
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											...
											<div class="col-md-4 col-sm-12">
												...
												<a class="btn red filter-cancel" type="reset" href="<?php echo U('Order/orderlist_ongoing?p=1');;?>"><i class="fa fa-times"></i> Reset</a>
												<!-- /input-group -->
											</div>
										</div>
									</div>
								...
								<div class="table-scrollable">
									...
									-->
									<tbody>
										<?php if(is_array($orders)): foreach($orders as $key=>$vo): ?><td><i class="fa fa-bug font-green"></i></td>
												...
												<td>
													<a class="btn  btn-xs red" href="<?php echo U('Order/ordereditpage?go=1&orderid='.$vo['orderid'].'');;?>">
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		...
																		<a href="<?php echo U('Order/orderdelete?go=1&orderid='.$vo['orderid'].'');;?>" type="button" class="btn blue"> Delete </a>
																	</div>
																</div>
																<!-- /.modal-content -->
															</div>
													...
													<?php if($vo["description"] != '' ): ?><a href="<?php echo U('Order/orderdetailpage?go=1&orderid='.$vo['orderid'].'');;?>" class="btn btn-xs yellow">
															<i class="fa fa-list-ul">
															</i>
														</a>
													<?php else: ?>
														<a href="<?php echo U('Order/orderdetailpage?go=1&orderid='.$vo['orderid'].'');;?>" class="btn btn-xs yellow">
