				...
				<div class="col-md-12 ">
					...
					<div class="portlet box purple ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Edit Worker
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" action="<?php echo U('Worker/workerupdate');;?>" method="post"  role="form">
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Wechat ID</label>
										<div class="col-md-9">
											<input type="text" name="wxid" class="form-control input-inline input-medium" placeholder="Enter wechat id" value=<?php echo ($worker["wxid"]); ?> readonly>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="wxname" class="form-control input-inline input-medium" placeholder="Enter wechat name" value=<?php echo ($worker["wxname"]); ?> required>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="input-group">
												...
												<input type="email" name="email" class="form-control input-inline input-medium" placeholder="Email Address" value=<?php echo ($worker["email"]); ?> required>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="checkbox-list">
												<?php if(is_array($teches)): foreach($teches as $key=>$vo): ?><label class="checkbox-inline">
														<?php if(in_array(($vo["techid"]), is_array($techarr)?$techarr:explode(',',$techarr))): ?><input type="checkbox" name="tech[]"  value="<?php echo ($vo["techid"]); ?>" checked> <?php echo ($vo["content"]); ?>
														<?php else: ?>
															<input type="checkbox" name="tech[]"  value="<?php echo ($vo["techid"]); ?>"> <?php echo ($vo["content"]); endif; ?>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea name="description" class="form-control" rows="3"><?php echo ($worker["description"]); ?></textarea>
										</div>
									</div>
								</div>
