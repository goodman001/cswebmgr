...
<div class="page-container">
	...
	<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Exchange Rate Edit <small>edit exchange</small>
			</h3>
			<div class="page-bar">
          ...
          <li>
					...
					<li>
						<a href="<?php echo U('Configure/exchangelist');;?>">Exchange Rate</a>
            <i class="fa fa-angle-right"></i>
					</li>
          <li>
						<a href="<?php echo U('Configure/exchangelist');;?>">Exchange Rate Edit</a>
					</li>
				</ul>
				...
				<div class="col-md-12 ">
					...
					<div class="portlet box purple ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Currency #<?php echo ($currency["currency"]); ?>
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" action="<?php echo U('Configure/editexchange');;?>" method="post"  role="form">
                				<div class="form-body">
									<div class="form-group">
										<label class="col-md-3 control-label">Currency</label>
										<div class="col-md-9">
                      <input name="currencyid" type="hidden" value="<?php echo ($currency["id"]); ?>" class="form-control input-inline input-medium" readonly>
											<input name="currency" type="text" placeholder="currency" value="<?php echo ($currency["currency"]); ?>" class="form-control input-inline input-medium" readonly>
										</div>
									</div>
									<div class="form-group has-error">
										<label class="col-md-3 control-label">Exchange Rating</label>
										<div class="col-md-9">
											<input name="rating" type="number" min="0" step="0.0001" class="form-control input-inline input-medium" value="<?php echo ($currency["rating"]); ?>" required>
											<span class="help-inline"> 1<?php echo ($currency["currency"]); ?> = ? RMB. </span>
										</div>
									</div>
                      ...
                      <a href="<?php echo U('Configure/exchangelist');;?>" type="button" class="btn default">Cancel</a>
										</div>
									</div>
								</div>
							</form>
