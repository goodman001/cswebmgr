...
<div class="content">
	...
	<form class="login-form" action="<?php echo U('Login/checkLog');;?>" method="post">
		...
		<div class="alert alert-danger display-hide">
			...
			<span>
			Enter username and password and code. </span>
		</div>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-key"></i>
				<input class="form-control placeholder-no-fix" type="password" placeholder="Code" autocomplete="off" name="code" required/>
			</div>
		</div>
